...
class FlowAugmentor4Img:
    ...
    def color_transform(self, *imgs):
        ...
        # symmetric
            ...
            image_stack = np.array(self.photo_aug(Image.fromarray(image_stack)), dtype=np.uint8)
            imgs = np.split(image_stack, len(imgs), axis=0)
    ...
    def spatial_transform(self, flow, *imgs):
        # randomly sample scale
        ht, wd = imgs[0].shape[:2]
        min_scale = np.maximum(
            (self.crop_size[0] + 8) / float(ht), 
    ...
    def __call__(self, img1, img2, img3, img4, flow):
        img1, img2, img3, img4 = self.color_transform(img1, img2, img3, img4)
        img1, img2, img3, img4 = self.eraser_transform(img1, img2, img3, img4)
        img1, img2, img3, img4, flow = self.spatial_transform(flow, img1, img2, img3, img4)
        ...
        return img1, img2, img3, img4, flow