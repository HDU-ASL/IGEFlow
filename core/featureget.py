...
parser.add_argument('--model', help="restore checkpoint", default='runs/raw_4img_origin_lyt_20w/checkpoints/180000_raw_4img_origin_lyt_20w.pth')
parser.add_argument('--small', action='store_true', help='use small model')
parser.add_argument('--mixed_precision', action='store_true', help='use mixed precision')
parser.add_argument('--alternate_corr', action='store_true', help='use efficent correlation implementation')
parser.add_argument('--use_enhance', action='store_true', default=True)
parser.add_argument('--result_path', default='runs/debug/PIC/ll_clean')
